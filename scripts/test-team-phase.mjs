import { calculateTeamPhaseInfo, getTeamDailyProblemBatch, calculatePhaseWinners } from "../src/lib/team-phase.js";
import { getProblemScore, getProblemPhase, compareLeaderboardRank, comparePhaseRank, DAILY_COMPLETION_BONUS } from "../src/lib/scoring.js";
import { SDE_SHEET_PROBLEMS } from "../src/data/sdeSheetProblems.js";
...
let sumProblems = 0;
for (let d = 0; d < 64; d++) {
  const dateStr = new Date(Date.UTC(2026, 8, 1 + d)).toISOString().split("T")[0];
