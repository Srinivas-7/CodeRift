...
export default function GlyphPortal({
  ...
  return (
    ...
    >
      <style>{`
        ${q}{--gp-paper:#0A0B10;--gp-ink:#F5F2EB;--gp-field:#081B15;--gp-foreground:#F5F2EB;position:relative;isolation:isolate;background:var(--gp-paper);color:var(--gp-ink);font-family:var(--font-sans, Arial, sans-serif);}
        ...
        ${q} [data-gp-letter]:focus-visible{outline:2px solid var(--accent-cobalt, #2148FF);outline-offset:5px;}
        ${q} [data-gp-touch-picker]{display:none;position:absolute;top:calc(var(--gp-word-bottom,50%) + 42px);left:50%;transform:translateX(-50%);font:12px/1.4 var(--font-mono, Arial, sans-serif);align-items:center;gap:12px;visibility:hidden;}
        ${q}[data-gp-choosing=true] [data-gp-touch-picker]{visibility:visible;}
        ${q} [data-gp-select]{min-height:44px;min-width:90px;border:1px solid rgba(245, 242, 235, 0.2);border-radius:4px;background:var(--gp-paper);color:var(--gp-ink);padding:0 10px;font:inherit;}
        ${q} [data-gp-select]:focus-visible{outline:2px solid var(--accent-cobalt, #2148FF);outline-offset:4px;}
        ...
        ${q} [data-gp-caption]{position:absolute;inset:auto 8% 9%;display:flex;align-items:center;justify-content:space-between;gap:1rem;font:13px/1.4 var(--font-mono, monospace);opacity:var(--gp-caption,1);pointer-events:var(--gp-caption-hit,auto);text-transform:uppercase;letter-spacing:0.08em;}
        ...
        ${q} [data-gp-hint]{max-width:30ch;color:var(--gp-ink);opacity:0.8;}
        ${q} [data-gp-enter]{display:inline-flex;align-items:center;gap:12px;min-height:44px;color:var(--text-primary, inherit);font:inherit;text-decoration:none;letter-spacing:inherit;font-weight:700;}
        ...
        ${q} [data-gp-default-title]{color:inherit;font:400 clamp(32px,5vw,72px)/1.05 var(--font-serif, Georgia, serif);letter-spacing:-.035em;max-width:13ch;margin:0 0 24px;text-wrap:balance;}
        ${q} [data-gp-default-copy]{color:inherit;font:16px/1.6 var(--font-sans, Arial, sans-serif);max-width:36ch;margin:0;}
